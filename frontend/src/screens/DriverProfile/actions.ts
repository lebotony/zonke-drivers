...
export const createThread = (params: { participant_id: string }) =>
  httpPost("/threads", params);

export const fetchDriverProfile = async (driverId: string) =>
  httpGet("/drivers/show_public", { id: driverId });
